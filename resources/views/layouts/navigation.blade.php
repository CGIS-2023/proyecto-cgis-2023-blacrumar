        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                   ...
                   <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('articulos.index')" :active="request()->routeIs('articulos.index') or request()->routeIs('articulos.create')">
                        {{ __('Artículos') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('proveedors.index')" :active="request()->routeIs('proveedors.index') or request()->routeIs('proveedors.create')">
                        {{ __('Proveedores') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('pedidos.index')" :active="request()->routeIs('pedidos.index') or request()->routeIs('pedidos.create')">
                        {{ __('Pedidos') }}
                    </x-nav-link>
                </div>
