    ...
    <x-slot name="header">
        <nav class="font-semibold text-xl text-gray-800 leading-tight" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
              ...
              <li>
                <a href="#" class="text-gray-500" aria-current="page">{{__('Editar')}} {{$articulo->user->name}}</a>
              </li>
            </ol>
          </nav>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <x-auth-validation-errors class="mb-4" :errors="$errors" />
                            ...
                            <div>
                                ...
                                <x-input id="name" readonly disabled class="block mt-1 w-full" type="text" name="name" :value="$articulo->user->name" required autofocus />
                            </div>
