    ...
    <x-slot name="header">
        <nav class="font-semibold text-xl text-gray-800 leading-tight" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex">
              ...
              <li>
                <a href="#" class="text-gray-500" aria-current="page">Crear artículo</a>
              </li>
            </ol>
          </nav>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <form method="POST" action="{{ route('articulos.store') }}">
                            ...
                            <div class="mt-4">
                                ...
                                <x-input id="cantidad" class="block mt-1 w-full" min="0" step="1" type="number" name="cantidad" :value="old('cantidad')" required />
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <x-input id="cantidad_minima" class="block mt-1 w-full" min="0" step="1" type="number" name="cantidad_minima" :value="old('cantidad_minima')" required />
                            </div>
